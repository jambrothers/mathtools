 ...
 * - Theme Awareness:
 *   - Uses `next-themes` to switch the logo based on system/user preference,
 *     although the toggle UI has been removed to reduce "tech vibe".
 */
export function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full z-50 border-b border-[var(--theme-border)] bg-[var(--theme-page)]/95 backdrop-blur-sm">
