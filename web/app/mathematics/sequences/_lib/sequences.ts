...
// Security: Enforce a reasonable upper bound for sequence length to prevent DoS
...
export function computeSequence(
  ...
  // Security: Clamp length to prevent DoS attacks
...
export function generateRandomParams(
  allowedTypes: SequenceType[] = ["arithmetic", "geometric", "quadratic"],
) {
  const sequenceType =
